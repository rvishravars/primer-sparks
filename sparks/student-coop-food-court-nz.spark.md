...
- Comparable: Meal quality and nutritional satisfaction are surveyed against existing campus options.
- Time-bounded: Financial viability is assessed over a minimum of two academic years.
- Refutable: If cost reduction <25%, or the coop requires ongoing subsidies to avoid losses, or meal quality significantly declines vs baseline, the hypothesis is rejected.
...
**Secondary Metrics**
- Participation: number of students who are coop members / active volunteers.
- Membership stability: renewal rates and active member count over time.
- Fair-use adherence: proportion of days where members stay within ration limits (no systematic abuse or resale patterns).
- Skills: self-reported learning in operations and basic budgeting.
