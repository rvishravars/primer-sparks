...
**The Shift:** Turn classrooms into "Student Comic Story Labs" where tamariki (ages ~6–12) create comics primarily in te reo Māori. AI is used **only** to turn student-authored ideas into child-friendly panels and layout suggestions—never to write full scripts. This normalises te reo as a living language of everyday stories and humour while building storytelling and digital citizenship skills.
...
Measurement relies on rubric-based narrative assessment of short writing tasks, blind-marked across both groups. We also monitor peer community indicators such as interest and "kind feedback" actions within the platform, and track the emergence of a visible comics culture through printed zines, wall displays, and school showcases.

## Outcomes
Observed results will track narrative writing scores and student-reported pride and ownership. Preliminary trials noted inconsistencies in AI-generated greyscale imagery, necessitating more tightly-constrained models or hybrid workflows. We monitor for teacher workload impact and infrastructure requirements tailored to New Zealand school networks. Revision notes focus on target age bands and the cultural framing of local stories in Aotearoa.
